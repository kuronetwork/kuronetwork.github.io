...
const categoryColors: Record<string, string> = {
  ...
  "讀書心得與雜談": "from-success/20 to-accent/20 border-success/30 hover:border-success/60",
  "理財投資": "from-yellow-500/20 to-orange-500/20 border-yellow-500/30 hover:border-yellow-500/60",
  "雲端運算與安全": "from-accent-blue/20 to-accent/20 border-accent-blue/30 hover:border-accent-blue/60",
};
